...
const Input: React.FC<InputProps> = ({ className, ...props }) => {
  const baseClasses = 
    "h-10 px-3 py-1 bg-white border border-stone-300 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm text-stone-900 disabled:opacity-50 disabled:cursor-not-allowed";
